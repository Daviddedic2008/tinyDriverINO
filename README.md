...
- diagonal lines are implemented on an unreleased version, but are buggy due to register conflicts between the ino compiled code and the raw asm function
